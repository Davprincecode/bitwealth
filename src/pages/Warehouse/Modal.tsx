...
import {toast } from 'react-toastify';
 ...
 const Modal : React.FC<modalPopUp> = ({isOpen, handleModal, handleProduct, productName,setProductName, productQuantity, setProductQuantity, productPrice, setProductPrice, sellingPrice, setSellingPrice, products, selectedProduct, handleSelectChange, productId, setProductId, setLoading, loading}) => {
